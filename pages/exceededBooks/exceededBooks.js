...
const URL = SERVER_URL + "/exceeded"


export function initExceededBooks() {
...
async function showbookDetails(evt) {
    ...
    const book = await fetch(SERVER_URL + "/" + id).then(res => res.json())
...
async function deletebook(id) {
    ...
    await fetch(SERVER_URL + "/" + id, options).then(res => handleHttpErrors(res))
}